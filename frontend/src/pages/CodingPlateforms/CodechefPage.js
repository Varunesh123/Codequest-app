...
import CodeChefLogo from '../../assets/codechef-logo.png'; // Ensure path is correct
...
const CodeChefPage = () => {
  ...
  const fetchContests = async (showRefreshing = false) => {
    ...
    try {
      const res = await fetch(`${process.env.REACT_APP_API_URL || 'http://localhost:5000'}/api/contests/codechef?_=${Date.now()}`, {
        headers: {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              <img src={CodeChefLogo} alt="CodeChef Logo" className="w-8 h-8" />
